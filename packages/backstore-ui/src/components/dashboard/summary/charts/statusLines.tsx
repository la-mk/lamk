...
export const statusLines = (t: TFunction) => [
  <Line
    ...
    stroke={getOrderStatusColor(sdk.order.OrderStatus.CANCELLED)}
  />,
  <Line
    isAnimationActive={false}
    ...
    stroke={getOrderStatusColor(sdk.order.OrderStatus.PENDING_PAYMENT)}
  />,
  <Line
    isAnimationActive={false}
    ...
    stroke={getOrderStatusColor(sdk.order.OrderStatus.PENDING_SHIPMENT)}
  />,
  <Line
    isAnimationActive={false}
    ...
    stroke={getOrderStatusColor(sdk.order.OrderStatus.SHIPPED)}
  />,
  <Line
    isAnimationActive={false}
    ...
    stroke={getOrderStatusColor(sdk.order.OrderStatus.COMPLETED)}
  />,
];
