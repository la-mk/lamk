...
const getTermsOfUse = ({
  ...
  return `
Термини и услови
Оваа интернет страна, со домеин www.agnesa.mk и www.agnesa.la.mk, во сопственост на Друштво за производтво, услуги и трговија на големо и мало ${companyName} со седиште: ${companyAddress} и Е.М.Б.С ${registryNumber}, Е.Д.Б ${taxNumber}, е сервис создаден за корисниците со цел да овозможи пребарување, споредба и/или купување на производи и услуги. Како посетител и корисник, Ви даваме до знаење дека употребата на содржините на страната, како и направените трансакции, се предмет на одредени услови и правила, за што Ве замолуваме пред користење на страната www.agnesa.mk и www.agnesa.la.mk внимателно да ги прочитате. ${companyName} не превзема никаква одговорност доколку корисникот ги нема прочитано условите и правилата за користење и купување.
...
Со Политикатата на приватност, ќе ви појасниме каде и како се чуваат личните податоци на сите регистрирани купувачи на нашата интернет страна. Оваа политика на приватност се однесува само за www.agnesa.mk и www.agnesa.la.mk и поддомените. Доколку е присутен линк кој ќе Ве поврзе со други страни, ние не превземаме никаква одговорност во однос на заштитата на личните податоци која ја обезбедуваат тие интернет страни.
...
Купувачот може да избере еден или повеќе производи, како и пакет на производи од понудата на ${storeName}. Купувачот може да ја откаже, дополни или корегира нарачката во било кое време, пред да го реализира плаќањето. Регистрирањето е задолжително за реализацијата на нарачката, и при нарачката, задолжителни се податоците за контакт, како и адреса
за испорака. По завршувањето на нарачката ќе Ви биде испратен e-mail на адресата која ја имате наведено, за потврда на нарачката. При евентуални технички проблеми со интернет страната, ${storeName} има право да ја одбие нарачката или да го прекине процесот на купување, и не сме обврзани да извршиме никакво обесштетување, освен враќање на уплатените средства од страна на купувачот.

Подршка на корисници
За било какви информации и прашања во врска со реализацијата на интернет продажба може да се јавите на телефонот ${phoneNumber} кој е достапен во периодот од 09:00 часот до 17:00 часот или да не комуницирате 24/7 преку нашиот e-mail 
