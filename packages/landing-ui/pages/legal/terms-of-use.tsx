...
Оваа интернет страна, со домеин ${slug}.la.mk, ${
    customDomain ?? ''
  } во сопственост на Друштво за услуги ${companyName} со седиште: ${companyAddress} и Е.М.Б.С ${registryNumber}, Е.Д.Б ${taxNumber}, е сервис создаден за корисниците со цел да овозможи креирање на интернет продавници. Како посетител и корисник, Ви даваме до знаење дека употребата на содржините на страната, како и направените трансакции, се предмет на одредени услови и правила, за што Ве замолуваме пред користење на страната ${slug}.la.mk, ${
    customDomain ?? ''
