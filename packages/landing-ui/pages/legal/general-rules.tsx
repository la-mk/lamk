...
Називот "${storeName}" е трговски знак на Друштво за производство,трговија и услуги ${companyName} со седиште: ${companyAddress} и Е.М.Б.С ${registryNumber}, Е.Д.Б ${taxNumber} и се забранува секаков вид на негова употреба без претходна писмена согласност од ${companyName}. ${companyName} ги задржува сите права кои произлегуваат од трговскиот знак "${storeName}".
